...
const GoogleSignIn = () => {
    ...
    const { error, loading, googleSignIn } = useGoogleSignIn();
        ...
        <div>
            ...
            {loading ?
                ...
                <motion.button
                    ...
                    className="flex items-center justify-center gap-2 w-full p-2 border border-primary-200 hover:bg-gray-50 font-onest font-medium rounded-md py-4 text-sm md:text-lg text-primary-200 shadow-xl"
